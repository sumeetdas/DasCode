...
public class PriorityQueueIntTest {
    @Test
    public void testPriorityQueueIntAcendingOrder() {
        final PriorityQueueInt pq = new PriorityQueueInt() {
            @Override
        ...
        assertEquals("element should be Integer.MIN_VALUE", Integer.MIN_VALUE, pq.pop());
